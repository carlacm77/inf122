...
function App() {
  return (
    <div className="App">
      ...
      image="evento01" dateLiteral="25 de Noviembre de 2023" 
      placeLiteral="Online" description="¡Hola Pythonista!
      ...
      Resumen: Cuando implementamos flujos de datos es muy común olvidar algunos detalles de diseño sumamente importantes para el buen funcionamiento de los procesos. En esta charla hablaremos de 3 de los más importantes y cuales son las implicaciones de implementarlos o no implementarlos.¡Hola Pythonista!
      ...
      ¡Anímate a ser parte de esta actividad!"  image="facebook"  image="youtube"  image="descarga" />

      <EventoC title="MeetUp 11 - 3 Pitfalls de la Ingeniería de datos (donde no meter la pata)" 
      image="evento01" dateLiteral="25 de Noviembre de 2023" 
      placeLiteral="Online" description={[
      "¡Hola Pythonista!",
      "Acompáñanos al MeetUp mensual de la comunidad Python La Paz",
      "En este MeetUp tendremos la participación de Valery Calderon Briz, Ingeniera en Telecomunicaciones actualmente trabajando como Ingeniera de datos Senior en One.Five",
      "Anteriormente Co-organizadora de Pyladies MX y Líder de la comunidad Python Guatemala",
